...
namespace API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCategoryById(int id)
        {
            ...
            return NotFound("Bu id'ye sahip categori yok!");
        }
        ...
        public async Task<IActionResult> UpdateCategory([FromForm] UpdateCategoryDTO model)
        {
            ...
            if (!await _categoryRepo.AnyAsync(x => x.Id == model.Id && x.Status != ApplicationCore.Entities.Abstract.Status.Passive))
            {
                return NotFound("Bu id'ye sahip bir category bulunamadı!");
            }
